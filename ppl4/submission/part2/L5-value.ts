...
import { append, join, concat,chain } from 'ramda';
...
export type SExpValue = number | boolean | string | PrimOp | Closure | SymbolSExp | EmptySExp | CompoundSExp | void | Tuple; //NEW 
...
//NEW
export const makeTuple = (list: Value[]): Tuple =>
    ({tag: "Tuple", list: list});
//NEW
